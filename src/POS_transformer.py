...
def base_lm_architecture(args):
    ...
    args.decoder_attention_heads = safe_getattr(
        args, "decoder_attention_heads", 8)
    args.adaptive_softmax_cutoff = safe_getattr(
        args, "adaptive_softmax_cutoff", None)
    args.adaptive_softmax_dropout = safe_getattr(
        args, "adaptive_softmax_dropout", 0)
    args.adaptive_softmax_factor = safe_getattr(
    ...
    args.decoder_layers_to_keep = safe_getattr(
    ...
    args.character_embeddings = safe_getattr(
    ...
    args.no_decoder_final_norm = safe_getattr(
    ...
    args.adaptive_input_cutoff = safe_getattr(
        args, "adaptive_input_cutoff", None)

    args.tie_adaptive_weights = safe_getattr(
    ...
    args.checkpoint_activations = safe_getattr(
...
@register_model_architecture("transformer_lm", "POS_transformer_predictor")
def POS_transformer_predictor(args):
